...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Formulir Pertanyaan Baru</h5>
...
<div class="content-body">
    <section class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('questionnaire.question.create.submit') }}" method="POST" enctype="multipart/form-data" id="form-create">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-6 col-md-6 col-sm-12">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tuliskan nomor" name="order" required>
                                    </fieldset> 
                                </div>
                            </div>
                            <fieldset class="form-group">
                                <label>Teks Pertanyaan <span class="text-danger">*</span></label>
                                <textarea class="form-control" rows="3" placeholder="Tuliskan pertanyaan" name="text" required></textarea>
                            </fieldset> 
                            <fieldset class="form-group">
                                <label>Tipe Pertanyaan <span class="text-danger">*</span></label>
                                <ul class="list-unstyled mb-0">
                                    @foreach ($questionnaire->question_types as $value => $label)
                                    <li class="d-inline-block mr-2 mb-1">
                                        <fieldset>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="type" id="type_{{ $value }}" value="{{ $value }}" required>
