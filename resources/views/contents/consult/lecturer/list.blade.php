...
<div class="alert alert-primary alert-dismissible mb-2" role="alert">
    ...
    <div class="d-flex align-items-center">
        ...
        <span>
            Dosen tidak dapat mengetahui data diri Mahasiswa, kecuali mahasiswa memberitahu informasi tentang dirinya sendiri.
        </span>
    </div>
</div>
                ...
                <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between" onclick="location.href = '{{ route('consult.lecturer.chat', ['id' => $item->id]) }}';">
                    <div class="list-left d-flex">
                        ...
                        <div class="list-content">
                            <span class="list-title">Mahasiswa #{{ $item->student->id }}</span>
